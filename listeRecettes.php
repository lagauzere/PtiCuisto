    ...
    <?php
        ...
        $sqlQuery = 'SELECT distinct REC_ID, REC_IMAGE, CAT_INTITULE, REC_RESUME, REC_TITRE
         FROM RECETTE,CATEGORIE Where RECETTE.CAT_ID in( Select CAT_ID From CATEGORIE where CAT_INTITULE = "entree" ) and CAT_INTITULE = "entree"';
            ...
            $sqlQuery = 'SELECT DISTINCT(REC_ID),REC_TITRE,REC_IMAGE,CAT_INTITULE,REC_RESUME FROM RECETTE,CATEGORIE Where REC_TITRE like "%'.$_POST['titre'].'%"and RECETTE.CAT_ID= CATEGORIE.CAT_ID';
            }
            ...
            like "%'.$_POST['ingredient'].'%" and lower(REC_CONTENU) like "%'.$_POST['ingredient'].'%" and RECETTE.CAT_ID= CATEGORIE.CAT_ID';
